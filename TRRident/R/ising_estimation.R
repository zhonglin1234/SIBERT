...
#' }
estimate_J1_dat <- function(genes, sp.dd, adj.umi = TRUE) {
  ...
  # Note: loc.raw and r.unit should be passed or available in scope
  # This will need to be refactored for proper package structure
